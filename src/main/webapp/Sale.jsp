...
<div id="butn">
<input type="submit" value="Sale" id="buy" class=" btn btn-primary btn-lg"> <input type="submit" value="Cancel" id="cancel" class="btn btn-danger btn-lg">
</div>
</form>
</div>
<div class="col-sm-3"></div>
